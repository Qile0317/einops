...
#'
#' This function is a placeholder that should be defined in the test env.
...
create_tensor <- function(values, dims, ...) {
    throw_not_implemented("create_tensor() must be defined in the test env")
}
...
create_seq_tensor <- function(dims, ...) {
    throw_not_implemented("create_seq_tensor() must be defined in the test env")
}
...
as_base_array <- function(x) {
    throw_not_implemented("as_base_array() must be defined in the test env")
}
...
flatten <- function(x) {
    throw_not_implemented("flatten() must be defined in the test env")
}
